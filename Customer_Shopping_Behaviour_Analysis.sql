...
--Q6. Which 5 Products have the highest eprcentage of  purchases with discount applied?
...
--Q7. Segment customers into, New, Returning, Loyal based on their total number of previous purchased, and show the count of each segment.
...
--Q9. 'Are customers who are repeat buyer (more than 5 previous purchases) aslo likely to subscribe'
